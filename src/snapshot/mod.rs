...
//! [`CollectedData`](collect::CollectedData) snapshot per call. The `diagram` renderers
//! are the sole consumers today. Both siblings sit on the same decode primitives in
