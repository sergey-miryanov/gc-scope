        ...
        impl ::std::fmt::Display for $ist {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "gil_runtime_state",
                    _fmt64(self.gil_runtime_state)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "gil_runtime_state_enabled",
                    _fmt64(self.gil_runtime_state_enabled)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "gil_runtime_state_locked",
                    _fmt64(self.gil_runtime_state_locked)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "gil_runtime_state_holder",
                    _fmt64(self.gil_runtime_state_holder)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "code_object_generation",
                    _fmt64(self.code_object_generation)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "tlbc_generation",
                    _fmt64(self.tlbc_generation)
                )
            }
        }
        impl ::std::fmt::Display for $tst {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "last_profiled_frame",
                    _fmt64(self.last_profiled_frame)
                )?;
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "native_thread_id",
                    _fmt64(self.native_thread_id)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "datastack_chunk",
                    _fmt64(self.datastack_chunk)
                )?;
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "gil_requested",
                    _fmt64(self.gil_requested)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "current_exception",
                    _fmt64(self.current_exception)
                )?;
        ...
        impl ::std::fmt::Display for $cot {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "localsplusnames",
                    _fmt64(self.localsplusnames)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "localspluskinds",
                    _fmt64(self.localspluskinds)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "co_code_adaptive",
                    _fmt64(self.co_code_adaptive)
                )?;
        ...
        impl ::std::fmt::Display for $unt {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    ...
                    "  {:<32} {}",
                    "asciiobject_size",
                    _fmt64(self.asciiobject_size)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "compactunicodeobject_size",
                    _fmt64(self.compactunicodeobject_size)
                )
            }
        }
        impl ::std::fmt::Display for $gct {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    f,
                    "  {:<32} {}",
                    "generation_stats_size",
                    _fmt64(self.generation_stats_size)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "generation_stats",
                    _fmt64(self.generation_stats)
                )
            }
        }
        ...
        impl ::std::fmt::Display for $dbt {
            fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
                ...
                writeln!(
                    ...
                    _fmt64(self.remote_debugger_support)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "remote_debugging_enabled",
                    _fmt64(self.remote_debugging_enabled)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "debugger_pending_call",
                    _fmt64(self.debugger_pending_call)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "debugger_script_path",
                    _fmt64(self.debugger_script_path)
                )?;
                writeln!(
                    f,
                    "  {:<32} {}",
                    "debugger_script_path_size",
                    _fmt64(self.debugger_script_path_size)
                )
            }
        }
    };
