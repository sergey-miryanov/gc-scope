...
// gcscope-source: sergey-miryanov/cpython@2acaf09a60f16ef5db6aaef3d06b7397b8f40ae1
//   CPython 3.15.0b1 (0x030f00b1) — describe v3.15.0b1-9-g2acaf09a60f
...
pub static GC_LAYOUT: GcItemLayout = GcItemLayout {
    ...
    fields: &[
        ...
        (
            "increment_size",
            std::mem::offset_of!(gc_generation_stats, increment_size),
        ),
        (
            "alive_size",
            std::mem::offset_of!(gc_generation_stats, alive_size),
        ),
        (
            "finalized_garbage_count",
            std::mem::offset_of!(gc_generation_stats, finalized_garbage_count),
        ),
        (
            "clear_weakrefs_count",
            std::mem::offset_of!(gc_generation_stats, clear_weakrefs_count),
        ),
        (
            "deleted_garbage_count",
            std::mem::offset_of!(gc_generation_stats, deleted_garbage_count),
        ),
        (
            "ts_mark_alive_start",
            std::mem::offset_of!(gc_generation_stats, ts_mark_alive_start),
        ),
        (
            "ts_mark_alive_stop",
            std::mem::offset_of!(gc_generation_stats, ts_mark_alive_stop),
        ),
        (
            "ts_fill_increment_start",
            std::mem::offset_of!(gc_generation_stats, ts_fill_increment_start),
        ),
        (
            "ts_fill_increment_stop",
            std::mem::offset_of!(gc_generation_stats, ts_fill_increment_stop),
        ),
        (
            "ts_deduce_unreachable_start",
            std::mem::offset_of!(gc_generation_stats, ts_deduce_unreachable_start),
        ),
        (
            "ts_deduce_unreachable_stop",
            std::mem::offset_of!(gc_generation_stats, ts_deduce_unreachable_stop),
        ),
        (
            "ts_handle_weakref_callbacks_start",
            std::mem::offset_of!(gc_generation_stats, ts_handle_weakref_callbacks_start),
        ),
        (
            "ts_handle_weakref_callbacks_stop",
            std::mem::offset_of!(gc_generation_stats, ts_handle_weakref_callbacks_stop),
        ),
        (
            "ts_finalize_garbage_stop",
            std::mem::offset_of!(gc_generation_stats, ts_finalize_garbage_stop),
        ),
        (
            "ts_handle_resurrected_stop",
            std::mem::offset_of!(gc_generation_stats, ts_handle_resurrected_stop),
        ),
        (
            "ts_clear_weakrefs_stop",
            std::mem::offset_of!(gc_generation_stats, ts_clear_weakrefs_stop),
        ),
        (
            "ts_delete_garbage_start",
            std::mem::offset_of!(gc_generation_stats, ts_delete_garbage_start),
        ),
        (
            "ts_delete_garbage_stop",
            std::mem::offset_of!(gc_generation_stats, ts_delete_garbage_stop),
        ),
    ],
};
