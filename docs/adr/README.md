...
| [0007](0007-gcstat-layout-driven-view.md) | `GcStat` is a lean layout-driven view over raw entry bytes (not a fixed field superset), giving one decode primitive shared by the exporter and TUI panel |
